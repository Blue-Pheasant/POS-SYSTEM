...
class m0002_importData
{
    public function up()
    {
		...
		$db = Application::$app->db;
        $sql = "INSERT INTO pos.users (id,firstname,lastname,email,phone_number,password,image_url,address,ward_id,district_id,province_id,role,created_at,updated_at) VALUES 
        ...
        $db = Application::$app->db;
        $sql = "INSERT INTO pos.categories (id,name,created_at,updated_at) VALUES
