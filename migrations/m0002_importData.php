...
class m0002_importData
{
    public function up()
    {
        ...
        $sql = "INSERT INTO pos.stores (id,address,status,image_url,created_at,updated_at,open_time,phone) VALUES
		...
		$db = Application::$app->db;
        $sql = "INSERT INTO pos.customers (id,firstname,lastname,email,phone_number,password,image_url,address,ward_id,district_id,province_id,role,created_at,updated_at) VALUES ('6191e42fe4e3f','admin','admin','admin@gmail.com','0123456789','" . password_hash('admin123', PASSWORD_DEFAULT) . "','','admin','','','','admin','2021-11-15 11:38:07','2021-11-15 11:38:07');";
        $db->pdo->exec($sql);

        $db = Application::$app->db;
        $sql = "INSERT INTO pos.category (id,name,created_at,updated_at) VALUES
        ...
        $db = Application::$app->db;
        $sql = "INSERT INTO pos.products (id,category_id,name,image_url,price,description,created_at,updated_at) VALUES
...
INSERT INTO pos.products (id,category_id,name,image_url,price,description,created_at,updated_at) VALUES
